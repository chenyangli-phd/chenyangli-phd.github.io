...
&emsp;&emsp;做自媒体或者其他行业的小伙伴经常会使用到gif，**视频转gif**，**图片转gif**，有些地方使用这些功能还收费，今天介绍的这个网站非常简单好用不收费，叫**图贴士**，界面简洁如下；
![](https://files.mdnice.com/user/25819/58a2b2ad-2caf-43b4-ae72-d39db2d8b59c.png)
网站链接🔗：https://www.tutieshi.com

## 视频转gif
&emsp;&emsp;视频转gif之前，我们只需要录制好视频，并上传到下面地方，可以选择要生成的**比例和宽度**，等待转换成功后下载即可；
![](https://files.mdnice.com/user/25819/0c831dac-bb8a-4385-92ee-77bd995d3afd.png)

## 图片合成gif

&emsp;&emsp;这个功能可以让**多个图片合成gif动图**，打包好我们需要的照片上传即可，同样可以选择要生成的**比例和宽度**；
![](https://files.mdnice.com/user/25819/17698f8b-dbfb-43de-948a-ea1107a3c06c.png)

## 其他功能

&emsp;&emsp;此外这个网站还提供了其他功能，比如**图片压缩**、**gif压缩**、**图片马赛克**、在线工具里还有**九宫格**等其他功能，不太常用，有需要的可以体验一下。
...
&emsp;&emsp;以上就是今天的全部内容，觉得好用的可以点个在看！

&emsp;&emsp;公众号**不喝水就犯困**（后台回复电影名即可在线看电影）。
